        ...
        <div class="row" style="margin-top: 20px;">
            <?php
                foreach ($result as $row) {
                    ...
                    echo '<a href="MenuPage.php?page=1&keyword=&categories[]=' . urlencode($categoryName) . '">';
...
foreach ($resultTopSellingItems as $row) {
    $itemID = $row['IDMONAN'];  // Correct variable name
    ...
    echo '<div class="card">';
    echo '<a href="product_details.php?id=' . $itemID . '">';  // Correct variable name
